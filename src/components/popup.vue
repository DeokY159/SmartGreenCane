  ...
  <div class="popup-overlay">
    ...
    <div class="popup-container">
      ...
      <div class="popup-content">
        <!-- 팝업 아이콘 이미지 -->
        <img :src="require('@/assets/impact.png')" alt="Impact Icon" class="impact-icon" />
        <!-- 팝업 제목 -->
        <h2 class="popup-title">Warning!</h2>
        <!-- 팝업 설명 -->
        <p class="popup-description">
          A blind person's fall was detected.
        </p>
      </div>
      <!-- 팝업 버튼 섹션 -->
...
.popup-buttons {
  ...
  justify-content: space-between; /* 버튼 사이 공간을 균등하게 */
}
...
/* CALL 버튼 호버 효과 */
.call-btn:hover {
  background-color: #c3e6cb; /* 진한 초록색 배경 */
}
